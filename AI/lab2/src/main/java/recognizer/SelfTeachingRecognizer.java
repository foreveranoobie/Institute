...
public class SelfTeachingRecognizer extends Recognizer {
    public SelfTeachingRecognizer(Scanner scanner) {
        super(scanner);
    }
            ...
            if (similarFirstAttribute == null && similarSecondAttribute != null) {
                ...
                switch (attribute.getLevel().getClass().getSimpleName()) {
                    ...
                    case "FourthLevel":
                        ...
                        boolean isInSecondRange = LevelUtil.numValueIsInRange(attribute.getLevel(), similarSecondAttribute.getLevel());
                        if (isInFirstRange) {
                            firstPolinomial++;
                        }
                        if (isInSecondRange) {
