    ...
    private JButton initAnalyzeInputButton() {
        ...
        button.addActionListener(event -> {
            ...
            if (bipolarValues.equals(numbersInfo.getLastSymbolBipolarValues())) {
                ...
                ofNullable(tableScrollPane).ifPresent(submainPanel::remove);

                tableScrollPane = new JScrollPane(resultPanel);
                tableScrollPane.setPreferredSize(new Dimension(750, 360));
                tableScrollPane.setMinimumSize(new Dimension(750, 360));
                submainPanel.add(tableScrollPane);
            }
